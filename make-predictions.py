...
model = Sequential()
model.add(Dense(40, activation='linear', input_shape=(X.shape[1],), W_regularizer=l2(0.01)))
model.add(Dropout(0.2))
model.add(Dense(40, activation='linear', W_regularizer=l2(0.01)))
model.add(Dropout(0.2))
model.add(Dense(40, activation='linear', W_regularizer=l2(0.01)))
model.add(Dropout(0.2))
model.add(Dense(40, activation='linear', W_regularizer=l2(0.01)))
...
#model.add(Dropout(0.2))
#model.add(Dense(100, activation='linear', W_regularizer=l2(0.01)))
#model.add(Dropout(0.2))
#model.add(Dense(100, activation='linear', W_regularizer=l2(0.01)))
#model.add(Dropout(0.2))
